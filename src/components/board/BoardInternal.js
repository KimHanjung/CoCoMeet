...
class externalNodeBaseComponent extends Component {
    render() {
        ...
        return connectDragSource(
            <div>
                <a class="ml-2 text-xs text-gray-700">채팅 블록</a>
                <div class="bg-paint-chatme ml-1 p-2 text-left text-white text-base font-normal border-none rounded-lg break-words">
                    {node.title}
                </div>
            </div>,
            {dropEffect: 'copy'}
    ...
    render() {
        ...
        return connectDropTarget(
            <div class="h-fullcalc w-full float-left" >
                <div class='pl-8 pt-3 flex'>
                    <div class="flex-grow ">
                    <button class="w-block bg-gray-200 rounded mr-2 font-semibold py-2 pl-2 pr-3 shadow-sm text-paint-blue hover:bg-paint-heheh focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                ...
                <div class="h-6-5/9 w-9/9 m-3 p-3" id={this.props.tree.treeID+"tree"}>
                    ...
                    <div class="h-2/9 w-full p-3">
                        <TrashNodeComponent>
                        <a class="flex items-center justify-center bg-transparent text-lg bg-gray-200 text-paint-blue font-semibold py-2 px-2 rounded">
