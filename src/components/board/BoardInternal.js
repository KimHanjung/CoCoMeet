        ...
        return connectDropTarget(
            <div class="h-fullcalc w-full float-left" >
                <div class='pl-8 pt-3 flex'>
                    <div class="flex-grow ">
                    <button class="w-block bg-gray-200 rounded mr-2 font-semibold py-2 px-2 shadow-sm text-paint-blue hover:bg-paint-heheh focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                ...
                <div class="h-7/9 w-9/9 m-3 p-3" id={this.props.tree.treeID+"tree"}>
