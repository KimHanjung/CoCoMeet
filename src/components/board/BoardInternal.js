    ...
    render() {
        ...
        return connectDragSource(
            <div>
                ...
                <div class="bg-paint-chatme ml-1 p-2 text-left text-white text-sm font-normal border-none rounded-lg break-words">
                    {node.title}
                </div>
            </div>,
            {dropEffect: 'copy'}
        ...
        return connectDropTarget(
            <div class="h-fullcalc w-full float-left" >
                <div class='pl-8 pt-3 flex'>
                    <div class="flex-grow ">
                    <button class="text-sm mr-2 w-block bg-gray-200 rounded font-semibold py-2 shadow-sm text-paint-blue hover:bg-paint-heheh focus:outline-none focus:ring-2 "
